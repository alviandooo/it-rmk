<div class="modal"  id="modal-tambah-sap">
    <div class="modal-dialog modal-md modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Tambah No SAP Item</h5>
        ...
        <div class="modal-body">
            <div class="form-inline">
                <div class="form-group">
                    ...
                    <select name="" id="id_item" class="single-select" style="">
                ...
                <div class="form-group mt-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="sap_item_number" >
                </div>
            </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary btn-sm" id="btn-simpan-sap">Simpan</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="page-content">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <h2>Data Item</h2>
                    <p>{{Breadcrumbs::render('kategori-pc')}}</p>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <a href="{{route('item.exportitembykategori',['3','1'])}}" class="btn btn-sm btn-warning" style="margin-bottom: 15px" target="_blank">Excel</a>
                        <a href="{{route('item.exportitembykategori',['3','2'])}}" class="btn btn-sm btn-danger" style="margin-bottom: 15px" target="_blank">PDF</a>
                        {{-- <button class="btn btn-sm btn-primary" style="margin-bottom: 15px" id="btn-tambah-item">Tambah</button> --}}

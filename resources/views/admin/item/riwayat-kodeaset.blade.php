            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table id="dtriwayatkode" class="table table-stripped table-hover" style="background-color: #fff; border-radius:5px; width:100%">
                            <thead>
                                <tr>
                                    <td>Nomor Aset</td>
                                    <td>Tanggal</td>
...
@section('script')
    <script>
        $(document).ready(function () {
            var dti = $('#dtriwayatkode').DataTable({
                "order":[[1, 'asc']],
            });  

            $('#dtriwayatkode tbody').on('click','.btn-nip', function () {
                var nip = this.text; 

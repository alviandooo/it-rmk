        ...
        <div class="modal-body">
            <div class="form-inline">
                ...
                <div class="form-group mt-2">
                    ...
                    <select name="" id="select_jenis_item" class="single-select">
                        <option value="1">Baru</option>
                        <option value="2">Stok</option>
                    </select>
                </div>

                <div class="form-group mt-2" style="display: none" id="div_kode_item">
                    <label for="">Kode Item :</label>
                    <select name="" id="kode_item" class="single-select">
                        @foreach ($itemconsumable as $ic)
                            <option value="{{$ic->kode_item}}">{{$ic->kode_item}} - {{$ic->nama_item}} - {{$ic->merk}}</option>
                        @endforeach
                    </select>
                </div>

                <div class="form-group mt-2 div_item" id="">
                    <label for="">Nama Item :</label>
                    <input type="text" class="form-control form-control-sm" id="nama_item" style="text-transform:uppercase">
                </div>
                <div class="form-group mt-2 div_item">
                ...
                <div class="form-group mt-2 div_item" style="display: none">

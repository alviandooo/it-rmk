    ...
    <div class="page-content">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <h2>Data Item</h2>
                    <p>{{Breadcrumbs::render('kategori-consumable')}}</p>
                </div>
            </div>
        </div>
...
@include('admin.item.consumable.form.form-add')
        ...
        $(document).ready(function () {
            ...
            $('#select_jenis_item').change(function () {
                if($('#select_jenis_item').val() == '2'){
                    $('#div_kode_item').css('display','block');
                    $('.div_item').css('display','none');

                }else{
                    $('#div_kode_item').css('display','none');
            ...
            $('#btn-tambah-item').click(function () {
                ...
                $('#select2kategori').val(6).change();

                $('#jumlah_item').css('display','block');
            });
            ...
            $('#btn-simpan-item').click(function () {
                ...
                data.append('select_jenis_item', $('#select_jenis_item').val());
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response.status == 201){
                            ...
                            var url = "{{url('/admin/item/consumable')}}";
                            window.location = url;

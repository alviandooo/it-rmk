...
<body>
    ...
    <div class="container">
        ...
        <div  style="margin-left:20px;margin-right:20px;margin-top:20px;">
            ...
            <table class="table-item" style=" width:100%; border-collapse:collapse; font-size:11pt">
                <tr>
                    <td><b>No</b></td>
            ...
            {{-- <ul class="nav">
                <li style="padding-right:100px;">
                    <div class="col-md-4" style="text-align: center">
                        <p style="padding-bottom:8px">Diserahkan Oleh</p>
                        <br><br><br>
                        <p>{{$datapenerima->nama}}</p>
                        <p style="margin-top: -12px">{{$datapenerima->jabatan->jabatan}}</p>
                    </div>
                </li>
                <li>
                    <div class="col-md-4" style="text-align: center">
